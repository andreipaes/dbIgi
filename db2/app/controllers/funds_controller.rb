class FundsController < ApplicationController
  ...
  private
    ...
    def fund_params
      params.require(:fund).permit(:name, :shortName, :isinCode, :cnpj, :exclusive, :nqPeerGroupName, :niPeerGroupName, :cvmClass, :anbimaClass, :adminFee, :performanceFeeDescription, :isIgi, :isIgiExotic, :hasRestriction, :targetClientList, :minimumInvestmentAmount, :vehicleType, :redemptionPaymentPeriod, :redemptionConversionPeriod, :totalShareHolders, :manager_id)
    end
end
